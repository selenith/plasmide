...
$templatePath='mods/admin/view/';

$stylePage='bodyAdmin';

$scripts='
		<script type="text/javascript" src="/mods/admin/style/templateAdmin.js"></script>
		<script type="text/javascript" src="/tools/jquery-migrate.min.js"></script>
		...
		<script type="text/javascript" src="/mods/admin/view/plasmideAdmin.js"></script>';
