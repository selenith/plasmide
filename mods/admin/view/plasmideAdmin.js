	...
	this.activerBarreAdmin = function(){
		$('#barreAdmin').html(
			...
			'		<span class="icon-bar"></span>'+
					'<span class="icon-bar"></span>'+
				  '</button>'+
				  '<a class="navbar-brand" href="/"><img alt="Brand" class="image-header" src="/mods/admin/style/images/plasmideLogo.png"></a>'+
				'</div>'+
				'<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">'+
				'  <ul class="nav navbar-nav navbar-right">		'+					
					'<li><a href="#gestArticle" >Articles</a></li>'+					
					'<li><a href="#gestMenu" >Menus</a></li>'+  
					'<li><a href="#gestCom" >Commentaires</a></li>'+  
					'<li><a href="#gestConf" >Parametres</a></li>'+  
					'<li><a href="#gestMedia" >Medias</a></li>'+  
					'<li><a href="#gestMembre" >Utilisateurs</a></li>'+  
